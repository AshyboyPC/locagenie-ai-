...
// Interactive Text Pressure effect component
// Adapted from provided template but simplified (no theme handling needed)
...
export const TextPressure: React.FC<TextPressureProps> = ({
  ...
  return (
    <div ref={containerRef} className="relative w-full h-full overflow-hidden bg-transparent">
      ...
      <h1
        ref={titleRef}
        className={`text-pressure-title uppercase text-center ${className} ${flex ? "flex justify-between" : ""} ${stroke ? "stroke" : ""}`}
        style={{
          fontFamily,
          fontSize,
          lineHeight,
